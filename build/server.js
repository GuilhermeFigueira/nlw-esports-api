...
app.post('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ad = yield prisma.ad.create({
        data: {
            ...
            hoursStart: (0, convert_1.convertHourToMinute)(body.hoursStart),
            hourEnd: (0, convert_1.convertHourToMinute)(body.hourEnd),
...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hoursStart: (0, convert_2.convertMinuteToHour)(ad.hoursStart), hourEnd: (0, convert_2.convertMinuteToHour)(ad.hourEnd) });
    }));
}));
